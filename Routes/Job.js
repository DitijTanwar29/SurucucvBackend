...
const { createJob, showAllJobs, updateJob, deleteJob, getJobDetails, approveAJobPost, getAllApprovedJobPosts, applyForJob, showAppliedJobs } = require("../controllers/Job");
...
router.get("/showAppliedJobs", showAppliedJobs);
